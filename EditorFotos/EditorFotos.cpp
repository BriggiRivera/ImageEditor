...
// EditorFotos.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEditorFotosApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEditorFotosApp

CEditorFotosApp::CEditorFotosApp()
{
...
// El único objeto CEditorFotosApp

CEditorFotosApp theApp;


// Inicialización de CEditorFotosApp

BOOL CEditorFotosApp::InitInstance()
{
